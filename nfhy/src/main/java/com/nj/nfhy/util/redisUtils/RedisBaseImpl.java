...
public class RedisBaseImpl implements RedisIntf {

	public static final String TKBASE = "redis_";

	@Autowired
	RedisShardedPool jedis;
...
//	RedisPool redisPool;
	 ...
	 * @return
	 */
	public boolean HSetSetValue(String domain, String key, String value) {
