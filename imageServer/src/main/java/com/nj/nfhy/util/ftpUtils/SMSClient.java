...
public class SMSClient {
	...
	/*
	 * 方法名称：mdgxsend 功 能：发送个性短信 (此方法用于发送多条内容不相同手机号多个的情况) 参
	 ...
	 * 数：mobile,content,ext,stime,rrid,msgfmt(手机号，内容，扩展码，定时时间，唯一标识，内容编码) 返 回
	 * 值：唯一标识，如果不填写rrid将返回系统生成的,群发手机号以逗号隔开，content以逗号隔开
	 *  示例：
	 * http://sdk2.entinfo.cn
	 * :8061/mdgxsend.ashx?sn=SDK-OFT-010-XXXXX&pwd=D86555F4EA11EFFA57E8F7DF7AAFFD3F
	 * &mobile=137****1021,137****1022&content=测试1,测试2&ext=&stime=&rrid=&msgfmt=
	 */
